...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside
        ...
        <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{route('categoryCourse.index')}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <script src="./Dashboardjs/plugins/smooth-scrollbar.min.js"></script>
    <script src="./Dashboardjs/plugins/chartjs.min.js"></script>
    <script>
