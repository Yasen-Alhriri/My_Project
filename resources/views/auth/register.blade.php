                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store') }}">
                            ...
                            <div class="form-group row">
                                <label for="f_name"
                                    class="col-md-4 col-form-label text-md-right">{{ __('F_Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="l_name"
                                    class="col-md-4 col-form-label text-md-right">{{ __('L_Name') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="role" type="number" class="form-control @error('role') is-invalid @enderror"
